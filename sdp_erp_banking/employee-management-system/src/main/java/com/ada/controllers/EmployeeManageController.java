...
import com.ada.service.EmployeeManageService;
import com.ada.service.UserInfoService;
...
public class EmployeeManageController {
    ...
    public ModelAndView submitApplyLeave(ModelAndView mav, @Valid LeaveDetails leaveDetails,
        ...
        if (bindingResult.hasErrors()) {
            ...
            employeeManageService.applyLeave(leaveDetails);
    ...
    String getAllLeaves(@RequestParam(value = "pending", defaultValue = "false") boolean pending,
        ...
        Iterator<LeaveDetails> iterator = employeeManageService.getAllLeaves().iterator();
        if (pending || accepted || rejected)
            iterator = employeeManageService.getAllLeavesOnStatus(pending, accepted, rejected).iterator();
    ...
    public ModelAndView manageLeaves(ModelAndView mav) {
        ...
        mav.addObject("leavesList", employeeManageService.getAllActiveLeaves());
    ...
    public ModelAndView acceptOrRejectLeaves(ModelAndView mav, @PathVariable("action") String action,
        ...
        LeaveDetails leaveDetails = employeeManageService.getLeaveDetailsOnId(id);
        ...
        employeeManageService.updateLeaveDetails(leaveDetails);
    ...
    public ModelAndView showMyLeaves(ModelAndView mav) {
        ...
        UserInfo userInfo = userInfoService.getUserInfo();
        List<LeaveDetails> leavesList = employeeManageService.getAllLeavesOfUser(userInfo.getEmail());
